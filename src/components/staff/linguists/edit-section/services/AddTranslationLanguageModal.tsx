...
interface AddTranslationLanguageModalProps {
  open: boolean;
  onClose: () => void;
  onSave: (data: TranslationLanguageData) => void;
}

const AddTranslationLanguageModal: React.FC<AddTranslationLanguageModalProps> = ({
  open,
  onClose,
  onSave,
}) => {
  const [formData, setFormData] = useState<TranslationLanguageData>({
    fromLanguage: "",
    toLanguage: "",
    yearsExperience: "",
    wordsTranslated: "",
  ...
  const handleChange = (field: keyof TranslationLanguageData, value: any) => {
  ...
  return (
    ...
    >
      ...
      >
        Translation & Multimedia Language
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <Box>
            ...
            <TextField
              ...
              size="small"
              type="number"
              value={formData.wordsTranslated}
              placeholder="Enter number of words"
              onChange={(e) => handleChange("wordsTranslated", e.target.value)}
            />
          </Box>
        </Box>
      </DialogContent>
...
export default AddTranslationLanguageModal;
